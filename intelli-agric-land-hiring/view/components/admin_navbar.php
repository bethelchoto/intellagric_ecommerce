            ...
            <div class="nav-item-wrapper">
              ...
              <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home-1">
                      ...
                      <li class="nav-item"><a class="nav-link active" href="apps/e-commerce/admin/add-product.php" data-bs-toggle="" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text">Add Product</span></div>
                          </a>
                      </li>
                      <li class="nav-item"><a class="nav-link" href="apps/e-commerce/admin/products.php" data-bs-toggle="" aria-expanded="false">
