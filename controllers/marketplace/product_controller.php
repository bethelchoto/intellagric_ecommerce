...
function add_product_ctr($cat_id, $brand_id, $product_title, $product_price, $product_desc, $newImageName, $product_keywords, $product_qnty, $product_doe, $product_discount){
    // Create an instance of the product model
    $product_model = new product_model();
    $addProduct = $product_model->add_product_mdl($cat_id, $brand_id, $product_title, $product_price, $product_desc, $newImageName, $product_keywords, $product_qnty, $product_doe, $product_discount);
    return $addProduct;
}
