                ...
                <div class="col-12 col-sm-auto">
                  ...
                  <div class="row g-4 flex-sm-column">
                    <div class="col-6 col-sm-12">
                      ...
                      </div><a class="fs-9 ms-4" href="#!">Shatinon Mekalan</a>
                    </div>
                    <div class="col-6 col-sm-12">
                      <div class="d-flex align-items-center mb-1"><span class="me-2" data-feather="mail" style="stroke-width:2.5;"></span>
                        <h6 class="mb-0">Email</h6>
                      </div><a class="fs-9 ms-4" href="mailto:shatinon@jeemail.com:">shatinon@jeemail.com</a>
                    </div>
                    ...
                    <div class="col-6 col-sm-12">
                      ...
                      </div><a class="fs-9 ms-4" href="tel:+1234567890">+1234567890</a>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-auto">
                ...
                <div class="col-12 col-sm-auto">
                  ...
                  <div class="row g-4 flex-sm-column">
                    <div class="col-6 col-sm-12">
                      ...
                      </div><a class="mb-0 text-body-secondary fs-9 ms-4">Yes</a>
                    </div>
                    <div class="col-6 col-sm-12">
