            ...
            <div class="nav-item-wrapper">
              ...
              <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="nv-home-1">
                      ...
                      <li class="nav-item"><a class="nav-link" href="https://intelli-agric-react-app.vercel.app/" data-bs-toggle="" aria-expanded="false">
                              <div class="d-flex align-items-center"><span class="nav-link-text">Visit Chat</span></div>
                          </a>
                      </li>
                  </ul>
              </div>
