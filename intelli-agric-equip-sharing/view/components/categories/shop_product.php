<nav class="ecommerce-navbar navbar-expand navbar-light bg-body-emphasis justify-content-between">
    <div class="container-small d-flex flex-between-center" data-navbar="data-navbar">
      ...
      <ul class="navbar-nav justify-content-end align-items-center">
        ...
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link" href="products-filter.php">Rent Equipment</a></li>
        ...
        <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-0" href="checkout.php">Checkout</a></li>
