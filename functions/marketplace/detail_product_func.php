...
function productImg($product_id){
        ...
        { ?>
                ...
                <div class="rounded-1 border border-translucent me-2 active" data-variant="Blue" data-products-images='["../../../../upload/marketplace/<?php echo $product_detail['product_image']; ?>","../../../../upload/marketplace/<?php echo $product_detail['product_image']; ?>","../../../../upload/marketplace/<?php echo $product_detail['product_image']; ?>"]'><img src="../../../../upload/marketplace/<?php echo $product_detail['product_image']; ?>" alt="" width="38" /></div>
